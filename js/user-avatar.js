...
const NAGRIVA_UserAvatar = (() => {
  ...
  function cacheRefs() {
    _refs = {
      ...
      navNotifBtn: document.getElementById('navNotifBtn'),
  ...
  function updateUI() {
    ...
    if (s.session && s.user) {
      ...
      if (r.navActions) {
        r.navActions.style.display = 'flex'
        r.navActions.classList.add('visible')
      }
      if (r.userAvatar) {
      ...
      if (r.navActions) {
        r.navActions.style.display = ''
        r.navActions.classList.remove('visible')
      }
      if (r.userAvatar) {
  ...
  function bindEvents() {
    ...
    if (r.navNotifBtn) {
      r.navNotifBtn.addEventListener('click', function(e) {
        if (typeof NAGRIVA_NotificationsDropdown !== 'undefined' && NAGRIVA_NotificationsDropdown.isOpen !== undefined) {
          return
        }
