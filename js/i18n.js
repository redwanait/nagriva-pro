...
;(function () {
  ...
  var translations = {
    en: {
      ...
      'services.seo': 'E-Commerce Development',
      'services.seo-desc': 'WordPress + WooCommerce stores with product setup and mobile responsive design.',
      'services.branding': 'Blog Creation',
      'services.branding-desc': 'WordPress and Blogger blogs with SEO-ready setup and professional design.',
      'services.ai-automation': 'Video Editing',
      'services.ai-automation-desc': 'Short-form video editing for Reels, Shorts, and TikTok content.',
      'services.social-media': 'Social Media',
      'services.social-media-desc': 'Strategic content creation and community growth across every major platform.',
    ...
    fr: {
      ...
      'services.web-design': 'Développement Web',
      'services.web-design-desc': 'Sites professionnels pour dentistes, avocats et sociétés de location auto.',
      'services.seo': 'Développement E-Commerce',
      'services.seo-desc': 'Boutiques WordPress + WooCommerce avec configuration produit et design responsive.',
      'services.branding': 'Création de Blog',
      'services.branding-desc': 'Blogs WordPress et Blogger avec configuration SEO et design professionnel.',
      'services.ai-automation': 'Montage Vidéo',
      'services.ai-automation-desc': 'Montage vidéo court pour Reels, Shorts et contenu TikTok.',
      'services.social-media': 'Médias Sociaux',
      'services.social-media-desc': 'Création de contenu stratégique et croissance communautaire.',
    ...
    ar: {
      ...
      'services.web-design': 'تطوير المواقع',
      'services.web-design-desc': 'مواقع مهنية لأطباء الأسنان والمحامين وشركات تأجير السيارات.',
      'services.seo': 'تطوير المتاجر الإلكترونية',
      'services.seo-desc': 'متاجر ووردبريس وووكومرس مع إعداد المنتجات وتصميم متجاوب.',
      'services.branding': 'إنشاء المدونات',
      'services.branding-desc': 'مدونات ووردبريس وبلوجر مع إعداد SEO وتصميم احترافي.',
      'services.ai-automation': 'تحرير الفيديو',
      'services.ai-automation-desc': 'تحرير فيديوهات قصيرة لـ Reels و Shorts ومحتوى TikTok.',
      'services.social-media': 'وسائل التواصل الاجتماعي',
      'services.social-media-desc': 'إنشاء محتوى استراتيجي ونمو مجتمعي عبر كل منصة رئيسية.',
